...
public record ConsultarObraResponse (String descricao, StatusObra status, EmpresaDto empresa, UnidadeFederativa uf, ZoneId fusoHorario, List<EtapaObra> etapas, List<ItemEap> eap){
}
